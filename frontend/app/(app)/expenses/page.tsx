  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-h2 font-bold text-text-primary">Expenses</h1>
      ...
      {!isLoading && !isError && groups && groups.length > 1 && (
        ...
        >
          <div>
            <h2 id="expenses-group-title" className="text-h3 font-semibold text-text-primary">
              Choose a group
            </h2>
            <p className="mt-1 text-body-sm text-text-muted">
                ...
                <Card variant="interactive" className="h-full">
                  <CardContent className="flex h-full flex-col gap-4 py-5">
                    ...
                    <div className="mt-auto flex items-center justify-between gap-3 border-t border-border-default pt-4">
                      ...
                      <span className="inline-flex items-center gap-1 text-body-sm font-medium text-primary-500">
                        Open
